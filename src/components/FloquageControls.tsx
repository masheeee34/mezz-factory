  ...
  return (
    <div className="w-full max-w-md">
      <div className="mb-3 flex items-center justify-between border-l-2 border-red-bright pl-3">
        ...
        <span className="text-xs text-muted">Aperçu en direct sur le verso</span>
      </div>

      <div className="flex flex-col gap-3">
        {/* NOM — éditable */}
        <label className="block">
          <span className="mb-1 block text-xs uppercase tracking-wider text-muted font-bold">
            NOM
          </span>
          <input
            type="text"
        ...
        <div className="flex items-center gap-3">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2 rounded-lg border border-line/40 bg-black/20 px-3 py-2">
              ...
              <span className="ml-auto text-xs text-muted italic">Édition limitée — non modifiable</span>
            </div>
          </div>
        </div>
      </div>
